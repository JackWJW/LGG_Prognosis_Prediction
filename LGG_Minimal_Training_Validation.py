...
######################################
def train_evaluate_model(random_state=42,outer_folds=3,inner_folds=3,inner_iterations=25,ANN_iterations=25,save_dir="./LGG_Minimal_Results",dataset_id=0):
    ...
    minimal_genes = ['A4GALT_1', 'B3GALT1_1', 'B3GALT5_1', 'B3GNT5_1', 'FUT9_1', 'ST3GAL1_1', 'ST3GAL4_1', 'ST6GALNAC2_1', 'ST8SIA5_1', 'UGCG_1']
    X = X[minimal_genes]
    print(f"Checking only using minimal genes: {list(X.columns)}")
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(outer_cv.split(X, y)):
        ...
        SAVE_DIR = f"./LGG_Minimal_Results/RS-{rs_number}_DS-Minimal_Results/ANN_Training_{fold_idx+1}"
